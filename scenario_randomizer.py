...
BASE_INPUTS: dict[str, Any] = {
    ...
    "purchase_price": 130_000_000,
    "market_rent_growth_min": 0.01,
    "market_rent_growth_max": 0.025,
    ...
    "operating_expenses_start": 3_200_000,
...
def _profile_ranges(profile: str) -> dict[str, tuple[float, float]]:
    ...
    profiles: dict[str, dict[str, tuple[float, float]]] = {
        "Conservative": {
            ...
            "purchase_price": (130_000_000, 142_000_000),
            "growth_min": (0.006, 0.018),
            "growth_spread": (0.005, 0.012),
            "exit_cap_mode": (0.090, 0.100),
            "market_to_in_place": (1.05, 1.16),
            "operating_expenses_start": (3_200_000, 3_800_000),
            ...
            "debt_ratio": (0.40, 0.50),
            "interest_rate": (0.0725, 0.0850),
        ...
        "Upside": {
            ...
            "purchase_price": (118_000_000, 130_000_000),
            "growth_min": (0.020, 0.034),
            "growth_spread": (0.006, 0.012),
            "exit_cap_mode": (0.0825, 0.090),
            "market_to_in_place": (1.10, 1.22),
            "operating_expenses_start": (2_800_000, 3_250_000),
        ...
        "Lease-Up Risk": {
            ...
            "purchase_price": (126_000_000, 140_000_000),
            "growth_min": (0.005, 0.025),
            "growth_spread": (0.004, 0.012),
            "exit_cap_mode": (0.085, 0.0975),
            "market_to_in_place": (1.02, 1.16),
            "operating_expenses_start": (3_200_000, 3_900_000),
